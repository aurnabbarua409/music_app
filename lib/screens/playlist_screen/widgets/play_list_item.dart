...
class PlayListItem extends StatelessWidget {
  const PlayListItem({super.key, required this.isPlaying});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isPlaying ? AppColor.black_900 : AppColor.black,
        border: Border.all(color: AppColor.fadeWhite, width: 0.2),
